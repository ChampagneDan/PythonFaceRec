...
class Application:
    def __init__(self, output_path = "./"):
        ...
        self.ref_name = "cj_weber"

        # Load a sample picture and learn how to recognize it.
        self.ref_image = face_recognition.load_image_file("/Users/cjlaptop/Desktop/" + self.ref_name + ".jpg")
        self.ref_face_encoding = face_recognition.face_encodings(self.ref_image)[0]
        [0]
...
#        frame = cv2.resize(frame, (1500,1000))
        if ok:  # frame captured without any errors
            ...
            for face_encoding in self.face_encodings:
                ...
                match = face_recognition.compare_faces([self.ref_face_encoding], face_encoding)
                name = "Unknown"
